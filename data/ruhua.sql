...
INSERT INTO `rh_banner` (`id`, `name`, `description`, `delete_time`, `update_time`) VALUES
...
CREATE TABLE `rh_coupon` (
  ...
  `goods_ids` text COMMENT '可用商品ID集合，0为全部商品',
  `region_id` int(11) NOT NULL COMMENT '地区ID,0所有区域',
  ...
  `full` decimal(10,2) NOT NULL COMMENT '满多少，0为无门槛',
  `reduce` decimal(10,2) NOT NULL COMMENT '减多少',
...
INSERT INTO `rh_delivery` (`id`, `name`, `method`, `sort`, `create_time`, `update_time`) VALUES
(1, '全国包邮', 1, 100, 1572398010, 1572398010);

-- --------------------------------------------------------

--
-- 表的结构 `rh_delivery_rule`
--

CREATE TABLE `rh_delivery_rule` (
...
CREATE TABLE `rh_goods` (
  ...
  `banner_imgs` varchar(255) NOT NULL,
  `goods_name` varchar(100) NOT NULL DEFAULT '' COMMENT '商品名称',
  `style` int(11) NOT NULL DEFAULT '0' COMMENT '0普通1虚拟',
...
CREATE TABLE `rh_order` (
  ...
  `is_milk` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `rh_order_goods` (
  ...
  `discount_id` int(11) NOT NULL DEFAULT '0' COMMENT '优惠活动ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='地区总表';

--
-- 转存表中的数据 `rh_region`
--

INSERT INTO `rh_region` (`id`, `pid`, `shortname`, `name`, `merger_name`, `level`, `pinyin`, `code`, `zip_code`, `first`, `lng`, `lat`) VALUES
...
(12, 'gzh_share_desc', '', '分享描述', 1, 0, 1576475519, 1576475519),
...
INSERT INTO `rh_template` (`id`, `temp_key`, `temp_name`, `content`, `temp_id`, `state`) VALUES
(1, 'OPENTM205213550', '新订单通知	', ' {{first.DATA}} 时间：{{keyword1.DATA}} 商品名称：{{keyword2.DATA}} 订单号：{{keyword3.DATA}} {{remark.DATA}}', '', 1),
(2, 'OPENTM410119152', '退款通知', '{{first.DATA}}\r\n订单号：{{keyword1.DATA}}\r\n退款金额：{{keyword2.DATA}}\r\n{{remark.DATA}}', '', 1),
(3, 'OPENTM417788812', '拼团成功通知', '{{first.DATA}}\r\n商品名称：{{keyword1.DATA}}\r\n团长：{{keyword2.DATA}}\r\n成团人数：{{keyword3.DATA}}\r\n{{remark.DATA}}', '', 1),
(4, 'OPENTM401113750', '拼团失败通知', '{{first.DATA}}拼团商品：{{keyword1.DATA}}商品金额：{{keyword2.DATA}}退款金额：{{keyword3.DATA}}{{remark.DATA}}', '', 1),
(5, 'OPENTM207791277', '订单支付成功通知', '{{first.DATA}} 订单编号：{{keyword1.DATA}} 商品名称：{{keyword2.DATA}} 订单总价：{{keyword3.DATA}} 订单状态：{{keyword4.DATA}} 下单时间：{{keyword5.DATA}} {{remark.DATA}}', '', 1);
...
CREATE TABLE `rh_user_coupon` (
  ...
  `full` decimal(10,2) NOT NULL COMMENT '满多少',
  `reduce` decimal(10,2) NOT NULL COMMENT '减多少',
...
--
-- 使用表AUTO_INCREMENT `rh_banner_item`
--
ALTER TABLE `rh_banner_item`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- 使用表AUTO_INCREMENT `rh_order_goods`
--
ALTER TABLE `rh_order_goods`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `rh_order_log`
--
ALTER TABLE `rh_order_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `rh_points_record`
--
ALTER TABLE `rh_points_record`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `rh_rate`
--
ALTER TABLE `rh_rate`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `rh_region`
--
ALTER TABLE `rh_region`
...
--
-- 使用表AUTO_INCREMENT `rh_user_address`
--
ALTER TABLE `rh_user_address`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `rh_user_coupon`
--
ALTER TABLE `rh_user_coupon`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
